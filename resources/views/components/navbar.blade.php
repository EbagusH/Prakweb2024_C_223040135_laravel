        ...
        <div class="flex h-16 items-center justify-between">
            ...
            <div class="flex items-center">
                <div class="flex-shrink-0">
                    <a href="/" class="text-white text-lg font-semibold">Praktikum Web</a>
                </div>
                ...
                <div class="ml-4 flex items-center md:ml-6">
                    <div class="relative" x-data="{ isProfileOpen: false }">
                        ...
                        <div
                            ...
                            <a href="/dashboard" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100"><i class="bi bi-layout-text-sidebar-reverse"></i> Dashboard</a>
                            <form action="/logout" method="POST">
                                @csrf
                                <button href="/logout" type="submit" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100"><i class="bi bi-box-arrow-right"></i> Logout</button>
                            </form>
                        </div>
                        @endauth
                        ...
                        @guest
                        <x-nav-link href="/login" :active="request()->is('login')"><i class="bi bi-box-arrow-in-right"></i> Login</x-nav-link>
                        @endguest
                    </div>
                </div>
            </div>
    ...
    <div x-show="isOpen" class="md:hidden">
        ...
        <div class="border-t border-gray-700 px-4 pt-4 pb-3">
            ...
            <div class="mt-3 space-y-1">
                <a href="/dashboard" class="block px-3 py-2 text-base font-medium text-gray-400 hover:bg-gray-700 hover:text-white"><i class="bi bi-layout-text-sidebar-reverse"></i> Dashboard</a>
                <form action="/logout" method="POST">
                    @csrf
                    <button href="/logout" type="submit" class="block px-3 py-2 text-base font-medium text-gray-400 hover:bg-gray-700 hover:text-white"><i class="bi bi-box-arrow-right"></i> Log out</button>
                </form>
            </div>
        </div>
        @endauth
