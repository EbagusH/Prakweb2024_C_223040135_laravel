        ...
        <main class="flex-1 p-6">
            ...
            <div class="bg-white w-full min-h-screen rounded-lg">
                <div class="bg-white p-6 rounded-lg w-full max-w-4xl mx-auto md:ml-1">
                    <form method="post" action="/dashboard/posts/{{ $post->slug }}" class="space-y-4" enctype="multipart/form-data">
                        ...
                        <div>
                            ...
                            <input type="text" id="title" name="title" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm @error('title') border-red-500 @enderror" required autofocus value="{{ old('title', $post->title) }}">
                        ...
                        <div>
                            ...
                            <input type="text" id="slug" name="slug" autocomplete="off" autofocus value="{{ old('slug', $post->slug) }}" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm @error('slug') border-red-500 @enderror">
